          ...
          <div className="mt-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-500">Instantly convert any website into a mobile app</p>
              </CardHeader>
              <CardContent>
                <ConvertToApp />
              </CardContent>
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      Yes you need to have your own Google Play or App Store Developer Account if you want to publish
                      the app in Google Play Store or App Store.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                      If you've enabled resource caching, the app might be showing cached content. You can disable
                      caching in the app settings or clear the app cache to see the updated content.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </CardContent>
